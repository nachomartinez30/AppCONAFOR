...
public class CETrazoSitio {
    ...
    private Float asignarDistancia(Integer cuadrante) {
        if ((cuadrante >= 0 && cuadrante <= 9) || (cuadrante <= -1 && cuadrante >= -9)) {
            return (float) 11.28;
        } else if ((cuadrante >= 10 && cuadrante <= 19) || (cuadrante <= -10 && cuadrante >= -19)) {
            return (float) 11.34;
        } else if ((cuadrante >= 20 && cuadrante <= 29) || (cuadrante <= -20 && cuadrante >= -29)) {
            return (float) 11.50;
        } else if ((cuadrante >= 30 && cuadrante <= 39) || (cuadrante <= -30 && cuadrante >= -39)) {
            return (float) 11.78;
        } else if ((cuadrante >= 40 && cuadrante <= 49) || (cuadrante <= -40 && cuadrante >= -49)) {
            return (float) 12.15;
        } else if ((cuadrante >= 50 && cuadrante <= 59) || (cuadrante <= -50 && cuadrante >= -59)) {
            return (float) 12.61;
        } else if ((cuadrante >= 60 && cuadrante <= 69) || (cuadrante <= -60 && cuadrante >= -69)) {
            return (float) 13.15;
        } else if ((cuadrante >= 70 && cuadrante <= 79) || (cuadrante >= -70 && cuadrante <= -79)) {
            return (float) 13.77;
        } else if ((cuadrante >= 80 && cuadrante <= 89) || (cuadrante <= -80 && cuadrante >= -89)) {
            return (float) 14.45;
        } else if ((cuadrante >= 90 && cuadrante <= 99) || (cuadrante <= -90 && cuadrante >= -99)) {
            return (float) 15.18;
        } else if ((cuadrante >= 100 && cuadrante <= 150) || (cuadrante <= -100 && cuadrante >= -150)) {
            return (float) 15.95;
        }
        return (float) 0.0;
    }
