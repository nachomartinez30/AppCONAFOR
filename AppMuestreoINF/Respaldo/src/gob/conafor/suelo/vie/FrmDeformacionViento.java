...
public class FrmDeformacionViento extends JInternalFrame {
    ...
    public void revisarDeformacionViento(CESitio ceSitio) {
        ...
        llenarTablaLongitudMonticulos();
        calcularMonticulos();
        if (ceSitio.getSitio() == 1) {
            lblColocacionTAG.setVisible(true);
            pnlColocacionTag.setVisible(true);
            ...
            this.pnlColocacionTag.setVisible(false);
            this.lblColocacionTAG.setVisible(false);
        }
        this.actualizar = 1;
        funciones.manipularBotonesMenuPrincipal(true);
        limpiarDatosMonticulos();
