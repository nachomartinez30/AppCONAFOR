...
public class FrmHojarascaProfundidad extends javax.swing.JInternalFrame {
  ...
  /*  private boolean validarCamposObligatoriosProfundidad030() {
    ...
    private boolean validarProfundidadReal() {
        if (this.profundidad030 < 0 || this.profundidad030 > 300) {
            ...
            txtProfundidad030.requestFocus();
            return false;
        } else if (this.profundidad3060 < 301 || this.profundidad3060 > 600) {
    ...
    private boolean validarPesoTotalSuelo() {
        if (this.pesoTotal030 < 0 || this.pesoTotal030 > 1000) {
            ...
            txtPesoTotal030.requestFocus();
            return false;
        } else if (this.pesoTotal3060 < 0 || this.pesoTotal3060 > 1000) {
  ...
  /*  private boolean validarCamposObligatoriosProfundidad3060() {
    ...
    private void initComponents() {
        ...
        txtEspesorHO.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        ...
        txtEspesorF.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        ...
        txtPesoTotalHO.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        ...
        txtPesoTotalF.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        ...
        txtPesoMuestraHO.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        ...
        txtPesoMuestraF.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        ...
        grdProfundidad.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        ...
        txtProfundidad3060.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        ...
        txtProfundidad030.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        ...
        txtPesoTotal030.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        ...
        txtPesoTotal3060.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(lblClave030, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        grdHojarasca.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        ...
        chkHojarasca.setText("Capas de hojarasca (HO) y fermentación (F)");
        ...
        chkSueloProfundidades.setText("Suelos a las profundidades de 0-30 y 30-60 ");
    ...
    private void btnAgregarHojarascaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarHojarascaActionPerformed
       fijarDatosHojarasca();
       if(validarCapturaHojarasca() && validarCapturaFermentacion() && validarDatosHojarasca()){
           crearHojarasca();
    ...
    private void btnAgregarProfundidadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarProfundidadActionPerformed
        ...
        if (validarCapturaProfundidad030() && validarCapturaProfundidad3060() && validarProfundidadReal() && validarPesoTotalSuelo()) {
            crearProfundidad();
