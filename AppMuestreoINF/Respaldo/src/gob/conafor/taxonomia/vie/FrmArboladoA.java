...
public class FrmArboladoA extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtNombreComun, javax.swing.GroupLayout.DEFAULT_SIZE, 86, Short.MAX_VALUE)
                .addGap(9, 9, 9))
        );
    ...
    private boolean validarCamposOpcionales() {
        ...
        if (cmbFormaFuste.isEnabled() && cmbFormaFuste.getSelectedItem() == null && condicion.getCondicionID() == 1) {
            ...
            JOptionPane.showMessageDialog(null, "Error! Debe capturar la altura comercial", "Arbolado A", JOptionPane.INFORMATION_MESSAGE);
            txtAlturaComercial.requestFocus();
            return false;
