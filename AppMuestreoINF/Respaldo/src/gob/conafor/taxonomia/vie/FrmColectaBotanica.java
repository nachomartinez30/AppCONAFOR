...
public class FrmColectaBotanica extends javax.swing.JInternalFrame {
    ...
    private void fijarValoresCampos(String claveColecta) {
        ...
        txtInfraespecie.setText(this.ceColecta.getInfraespecie());
    ...
    private void initComponents() {
        ...
        txtInfraespecie = new javax.swing.JTextField();
        ...
        txtInfraespecie.setEnabled(false);
        txtInfraespecie.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtInfraespecieFocusGained(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(125, 180, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtInfraespecie, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(lblNombreComun)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtNombreComun, javax.swing.GroupLayout.DEFAULT_SIZE, 109, Short.MAX_VALUE))
                    ...
                    .addComponent(lblObservacionesColecta, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lblInfraespecie)
                    .addComponent(txtInfraespecie, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblNombreComun)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblObservacionesColecta)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void txtInfraespecieFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtInfraespecieFocusGained
        txtInfraespecie.selectAll();
    }//GEN-LAST:event_txtInfraespecieFocusGained
    ...
    private void cmbFamiliaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbFamiliaActionPerformed
        ...
        if (indexFamilia == null && indexGenero == null) {
            funciones.reiniciarComboModel(cmbGenero);
            fillCmbGeneroSF();
        } else if (indexFamilia != null && indexGenero == null) {
            funciones.reiniciarComboModel(cmbGenero);
            fillCmbGenero(indexFamilia.getFamiliaID());
        } else if (indexFamilia == null && indexGenero != null) {
            funciones.reiniciarComboModel(cmbGenero);
            fillCmbGeneroSF();
        }
    ...
    private javax.swing.JTextField txtInfraespecie;
