...
public class FrmSotoBosque extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cmbGenero.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(PnlDescripcion1, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(5, 5, 5))
                    .addComponent(chkSotobosque))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void cmbGeneroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbGeneroActionPerformed
        ...
        //JOptionPane.showMessageDialog(null, indexGenero.getGeneroID());
        if (indexGenero != null) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (validarSotoBosqueVacios() && validarDatosSotoBosque()) {
            ...
            llenarTabla();
            combo.reiniciarComboModel(cmbGenero);//Prueba
            cmbGenero.addItem(null);//Prueba
            limpiarControles();
        }
    ...
    private void cmbGeneroKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbGeneroKeyTyped
        fillCmbGeneroFiltrado(evt.getKeyChar());//Prueba
    }//GEN-LAST:event_cmbGeneroKeyTyped
