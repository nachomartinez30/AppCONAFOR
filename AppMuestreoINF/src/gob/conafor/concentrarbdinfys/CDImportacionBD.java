...
public class CDImportacionBD {
        ...
        try {
                    ...
                    if (this.upmIDExterno == this.upmIDLocal) {
                        ...
                        int respuesta = JOptionPane.showOptionDialog(null,
                                "El UPMID: " + this.upmIDExterno
                                        + " ya se encuentra en la base de datos local, ¿desea reeplazarlo?",
                                "Importaci�n", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opciones,
                                opciones[1]);
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos al revisar la importaci�n de la tabla UPM_UPM",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void eliminarRepetido(int upmID) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo eliminar la informaci�n del UPMID repetido ",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                conn.close();
    ...
    public void importarUPM_UPM(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla UPM_UPM",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla UPM_UPM", "Conexion BD",
    ...
    public void importarPC(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla PC_PuntoControl",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla PC_PuntoControl",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarAccesibilidadPC(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla PC_Accesibilidad", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla PC_Accesibilidad",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSitios(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla SITIOS_Sitio",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SITIOS_Sitio", "Conexion BD",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSitiosCoberturaSuelo(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SITIOS_CoberturaSuelo", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SITIOS_CoberturaSuelo",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarFotografiaHemisferica(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SITIOS_FotografiaHemisferica", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SITIOS_FotografiaHemisferica",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarTransponder(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SITIOS_Transponder", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SITIOS_Transponder",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarParametrosFisicoQuimicos(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SITIOS_ParametrosFisicoQuimicos",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SITIOS_ParametrosFisicoQuimicos",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloCanalillo(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla SUELO_Canalillo",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_Canalillo",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloCarcava(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla SUELO_Carcava",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_Carcava", "Conexion BD",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloCobertura(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_CoberturaSuelo", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_CoberturaSuelo",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloCostras(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla SUELO_Costras",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_Costras", "Conexion BD",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloDeformacionViento(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_DeformacionViento", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_DeformacionViento",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloErosionHidricaCanalillo(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_ErosionHidricaCanalillo",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_ErosionHidricaCanalillo",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloErosionHidricaCarcava(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_ErosionHidricaCarcava", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_ErosionHidricaCarcava",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloErosionLaminar(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_ErosionLaminar", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_ErosionLaminar",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public int extraerSitioIDEvidenciaErosion(int coberturaSuelioID, String ruta) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error! no se encont� sitioID en SUELO_CoberturaSuelo", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
        return sitioID;
    ...
    public void importarSueloEvidenciaErosion(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_EvidenciaErosion", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_EvidenciaErosion",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloHojarasca(String ruta) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    null, "Error! no se pudo importar la informaci�n de la tabla SUELO_Hojarasca"
            ...
            try {
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_Hojarasca",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloLongitudCanalillo(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_LongitudCanalillo", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_LongitudCanalillo",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloLongitudCarcava(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_LongitudCarcava", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_LongitudCarcava",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloLongitudMonticulo(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_LongitudMonticulo", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_LongitudMonticulo",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloMedicionCanalillos(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_MedicionCanalillos", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SSUELO_MedicionCanalillos",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloMedicionCarcavas(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_MedicionCarcavas ", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SSUELO_MedicionCarcavas ",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloMuestras(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla SUELO_Muestras ",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_Muestras ",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloMuestrasPerfil(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_MuestrasPerfil ", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_MuestrasPerfil ",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloPavimentos(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_PavimentosErosi�n", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_PavimentosErosi�n",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloPedestal(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla SUELO_Pedestal",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_Pedestal", "Conexion BD",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloProfundidad(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_Profundidad ", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_Profundidad ",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloInformacion(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla SUELO_Suelo",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_Suelo", "Conexion BD",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSueloVarillasErosion(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUELO_VarillasErosion", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUELO_VarillasErosion",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarCarbonoCoberturaDosel(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla CARBONO_CoberturaDosel", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla CARBONO_CoberturaDosel",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarCarbonoCubiertaVegetal(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla CARBONO_CubiertaVegetal", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla CARBONO_CubiertaVegetal",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarCarbonoLongitudComponente(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla CARBONO_LongitudComponente", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla CARBONO_LongitudComponente"
                                + e.getClass().getName() + " : " + e.getMessage(),
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public void importarCarbonoMaterialLenioso100(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla CARBONO_MaterialLenioso100", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla CARBONO_MaterialLenioso100",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarCarbonoMaterialLenioso1000(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla CARBONO_MaterialLenioso1000", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla CARBONO_MaterialLenioso1000",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarTaxonomiaArbolado(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla TAXONOMIA_Arbolado", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla TAXONOMIA_Arbolado",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSubmuestra(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla ARBOLADO_Submuestra", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla ARBOLADO_Submuestra"
                                + e.getClass().getName() + " : " + e.getMessage(),
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public void importarSubmuestraTroza(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla ARBOLADO_Troza",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla ARBOLADO_Troza", "Conexion BD",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSubmuestraObservaciones(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SUBMUESTRA_Observaciones", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SUBMUESTRA_Observaciones",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarArboladoDanioSeveridad(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla ARBOLADO_DanioSeveridad", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla ARBOLADO_DanioSeveridad",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarTaxonomiaColectaBotanica(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla TAXONOMIA_ColectaBotanica", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla TAXONOMIA_ColectaBotanica",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarTaxonomiaRepoblado(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla TAXONOMIA_Repoblado", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla TAXONOMIA_Repoblado",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarTaxonomiaRepobladoVM(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla TAXONOMIA_RepobladoVM", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla TAXONOMIA_RepobladoVM",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarTaxonomiaSotoBosque(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla TAXONOMIA_SotoBosque", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla TAXONOMIA_SotoBosque",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarTaxonomiaVegetacionMayorGregarios(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla TAXONOMIA_VegetacionMayorGregarios",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla TAXONOMIA_VegetacionMayorGregarios",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarVegetacionMayorGDanioSeveridad(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla VEGETACIONMAYORG_DanioSeveridad",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla VEGETACIONMAYORG_DanioSeveridad",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
    ...
    public void importarTaxonomiaVegetacionMayorIndividual(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla TAXONOMIA_VegetacionMayorIndividual",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla TAXONOMIA_VegetacionMayorIndividual",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
    ...
    public void importarVegetacionMayorIDanioSeveridad(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla VEGETACIONMAYORI_DanioSeveridad",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla VEGETACIONMAYORI_DanioSeveridad",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarTaxonomiaVegetacionMenor(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla TAXONOMIA_VegetacionMenor", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla TAXONOMIA_VegetacionMenor",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarVegetacionMenorDanioSeveridad(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla VEGETACIONMENOR_DanioSeveridad",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla VEGETACIONMENOR_DanioSeveridad",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarRepobladoDanioSeveridad(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla REPOBLADO_AgenteDanio", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla REPOBLADO_AgenteDanio",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarUPMContacto(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla UPM_Contacto",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla UPM_Contacto", "Conexion BD",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarUPMEpifitas(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla UPM_Epifita",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla UPM_Epifita", "Conexion BD",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarSecuencias(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SYS_SecuenciaCaptura", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SYS_SecuenciaCaptura",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void importarUPMRevision(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Error! no se pudo importar la informaci�n de la tabla SYS_UPM_Revision", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla SYS_UPM_Revision",
                        "Conexion BD", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public int extraerSitioIDVegetacionMayorIndividual(int vegetacioMayorIID, String ruta) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error! no se encont� Sitio TAXONOMIA_VegetacionMayorIndividual",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
        return sitioID;
    ...
    public int extraerSitioIDVegetacionMenor(int vegetacioMenorID, String ruta) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error! no se encont� Sitio TAXONOMIA_VegetacionMenor", "Conexion BD",
                    JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
        return sitioID;
    ...
    public int extraerSitioIDVegetacionMayorGregarios(int vegetacioMayorID, String ruta) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error! no se encont� Sitio TAXONOMIA_VegetacionMayorGregarios",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
        return sitioID;
    ...
    public int extraerSitioARBOLADODanioSeveridad(int arboladoID, String ruta) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error! no se encont� SitioID De ARBOLADO_DanioSeveridad",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    ...
    public int extraerUPM(int sitioID, String ruta) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error! no se encont� UPM", "Conexion BD", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    ...
    public void importarBrigadas(String ruta) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error! no se pudo importar la informaci�n de la tabla UPM_Brigada",
                    "Conexion BD", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                baseDatosLocal.close();
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null,
                        "Error! al cerrar la base de datos en la importaci�n de la tabla UPM_Brigada", "Conexion BD",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
