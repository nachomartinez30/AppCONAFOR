...
import gob.conafor.sys.mod.CDEliminarBaseDatos;
...
public class HiloEliminacion extends SwingWorker<Integer, String> {
    ...
    private CDEliminarBaseDatos cdEliminar = new CDEliminarBaseDatos();
    ...
    protected Integer doInBackground() {
        ...
        //cdEliminar.eliminarSitios();
        cdEliminar.eliminarUPM();
        try {
            Thread.sleep(1000);
        } catch (Exception e) {
            e.printStackTrace();
