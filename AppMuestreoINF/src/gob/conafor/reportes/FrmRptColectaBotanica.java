...
public class FrmRptColectaBotanica extends javax.swing.JInternalFrame {
    
    private FuncionesComunes funcionesComunes = new FuncionesComunes();
    
    public FrmRptColectaBotanica() {
        initComponents();
    }
    ...
    public void llenarReporte(int upmID){
       ...
       try {
            Map colectaParametros = new HashMap();
            //BufferedImage image = ImageIO.read(getClass().getResource("/gob/conafor/reportes/CONAFOR_231_100px.png"));
            BufferedImage image = ImageIO.read(this.getClass().getResourceAsStream("/gob/conafor/reportes/CONAFOR_231_100px.png"));
            colectaParametros.put("UPMID", upmID);
            colectaParametros.put("RutaImagen", image);
            Connection conn = LocalConnection.getConnection();
            //File fileReporteColecta = new File("src/gob/conafor/reportes/ColectaBotanica.jrxml");
            File fileReporteColecta = new File("lib/ColectaBotanica.jrxml");
            JasperReport jr = JasperCompileManager.compileReport(fileReporteColecta.getAbsolutePath());
            //System.out.println(fileReporteColecta.getAbsolutePath());
            JasperPrint jp = JasperFillManager.fillReport(jr, colectaParametros, conn);
            ...
            conn.close();
             ...
             JOptionPane.showMessageDialog(null,
                    "Error! no se pudo obtener el reporte de colectas botanicas" + e.getClass().getName() + " : " + e.getMessage(),
